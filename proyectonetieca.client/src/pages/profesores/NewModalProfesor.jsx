...
const NewModalProfesor = ({ isOpen, onClose, onUpdate }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`${IP_SERVER}/Profesores/save`, {
                nombre,
                apellido,
                email,
                perfil,
        ...
        <div className={`fixed inset-0 z-50 flex items-center justify-center ${isOpen ? 'block' : 'hidden'}`}>
            ...
            <div className="bg-white w-full max-w-md p-6 rounded-md z-10">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Nuevo Profesor</h3>
...
export default NewModalProfesor;