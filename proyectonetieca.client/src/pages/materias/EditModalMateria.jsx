...
const EditModalMateria = ({ materiaId, profesorId, isOpen, onClose, onUpdate, initialMateriaData }) => {
    ...
    useEffect(() => {
        if (initialMateriaData) {
            setNombre(initialMateriaData.nombre);
            setDescripcion(initialMateriaData.descripcion);
        }
    }, [initialMateriaData]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`${IP_SERVER}/Materias/edit`, {
                materiaId,
                nombre,
                descripcion,
        ...
        <div className={`fixed inset-0 z-50 flex items-center justify-center ${isOpen ? 'block' : 'hidden'}`}>
            ...
            <div className="bg-white w-full max-w-md p-6 rounded-md z-10">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Editar Materia: {materiaId}</h3>
                        ...
                        <div className="col-span-2">
                            ...
                            <select value={selectedProfesorId} onChange={handleChange} className="border rounded-lg px-4 py-2">
                                ...
                                {profesores.map((profesor) => (
                                    <option key={profesor.profesorId} value={profesor.profesorId} selected={profesor.profesorId == profesorId}>
...
export default EditModalMateria;