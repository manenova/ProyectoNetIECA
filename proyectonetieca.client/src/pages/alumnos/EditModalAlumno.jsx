...
const EditModalAlumno = ({ alumnoId, isOpen, onClose, onUpdate, initialAlumnoData }) => {
    ...
    useEffect(() => {
        ...
        if (initialAlumnoData) {
            ...
            setEmail(initialAlumnoData.email);
            setGrado(initialAlumnoData.grado);
        }
    }, [initialAlumnoData]);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`${IP_SERVER}/Alumnos/edit`, {
                alumnoId,
                nombre,
                apellido,
                email,
            ...
            <div className="fixed inset-0 bg-gray-900 opacity-50"></div>
                <div className="bg-white w-full max-w-md p-6 rounded-md z-10">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-gray-900">Editar Alumno: {alumnoId}</h3>
...
export default EditModalAlumno;